...
def get_args():
    parser = argparse.ArgumentParser('CLIP fine-tuning and evaluation script for image classification', add_help=False)
    ...
    parser.add_argument('--layer_scale_init_value', default=0, type=float,
                        help="set 0 to disable layer scale")
    ...
    parser.add_argument('--clip_mean_and_std', default=False, action='store_true')
    ...
    parser.add_argument('--resume_tag', default='best')
...
def main(args, ds_init):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            device, epoch, loss_scaler, args.clip_grad, model_ema=model_ema, mixup_fn=mixup_fn,
